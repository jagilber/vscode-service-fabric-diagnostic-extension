...
The **ServiceFabric** PowerShell module is required for connecting to and managing Service Fabric clusters.

#### ✅ Already Installed On:
- **Service Fabric cluster nodes** - Pre-installed with Service Fabric runtime
- **Service Fabric SDK installations** - Included with full SDK

#### 🔍 Check if Installed

\`\`\`powershell
# Check if ServiceFabric module is available
Get-Module -ListAvailable -Name ServiceFabric

# Expected output if installed:
#   Directory: C:\\Program Files\\Microsoft SDKs\\Service Fabric\\Tools\\PSModule\\ServiceFabric
#   ModuleType Version    Name              ExportedCommands
#   ---------- -------    ----              ----------------
#   Manifest   3.4.658... ServiceFabric     {Add-ServiceFabricNode, ...
\`\`\`

#### 📥 Installation Options

**Option 1: Service Fabric SDK (Recommended for Development)**
- **Download:** [Service Fabric SDK](https://aka.ms/servicefabric)
- **Includes:** Full development tools, PowerShell module, Local Cluster Manager
- **Platform:** Windows only
- **Size:** ~500 MB
- **Use Case:** Development workstations, build servers

**Option 2: Service Fabric Runtime**
- **Download:** [Service Fabric Runtime](https://learn.microsoft.com/azure/service-fabric/service-fabric-get-started#install-the-sdk-and-tools)
- **Includes:** Runtime binaries and PowerShell module
- **Platform:** Windows Server or Windows 10/11
- **Use Case:** Cluster nodes, management servers

**Option 3: PowerShell Gallery (Cross-Platform)**
- **Module:** Microsoft.ServiceFabric.Powershell.Http
- **Platform:** Windows, Linux, macOS (PowerShell 7+)
- **Use Case:** Cross-platform management, backup/restore operations

\`\`\`powershell
# Install cross-platform HTTP module
Install-Module -Name Microsoft.ServiceFabric.Powershell.Http -AllowPrerelease
\`\`\`

📚 **References:**
- [Service Fabric SDK Download](https://aka.ms/servicefabric)
- [Get Started with Service Fabric](https://learn.microsoft.com/azure/service-fabric/service-fabric-get-started)
...
**If you're on a Service Fabric node:**
- The module is already installed - just open PowerShell and start using cmdlets
- No additional downloads needed

**If you're on a development machine:**
- Install Service Fabric SDK for full tooling experience
- Includes Local Cluster Manager for testing

**For remote management:**
- Only PowerShell module needed (part of SDK)
- Can connect to any cluster from any Windows machine with SDK installed
