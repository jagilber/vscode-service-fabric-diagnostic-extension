...
export class serviceFabricClusterView implements vscode.TreeDataProvider<TreeItem> {
    ...
    private loadCommandsChildren(commandsItem: TreeItem): TreeItem[] {
        ...
        children.push(new TreeItem('📘 PowerShell Guides', {
        ...
        children.push(new TreeItem('Cluster Operations', {
            children: clusterOps,
            resourceUri: commandsItem.resourceUri,
        ...
        children.push(new TreeItem('Application Lifecycle', {
            children: appOps,
            resourceUri: commandsItem.resourceUri,
        ...
        children.push(new TreeItem('Partition & Replica Operations', {
        ...
        children.push(new TreeItem('Testing & Chaos', {
            children: testingOps,
            resourceUri: commandsItem.resourceUri,
            iconPath: new vscode.ThemeIcon('beaker', new vscode.ThemeColor('charts.yellow')),
            itemType: 'command-category',
        ...
        children.push(new TreeItem('Backup & Restore', {
            children: backupOps,
            resourceUri: commandsItem.resourceUri,
        ...
        children.push(new TreeItem('Repair & Infrastructure', {
            children: repairOps,
            resourceUri: commandsItem.resourceUri,
        ...
        SfUtility.outputLog(`Loaded ${children.length} command categories`, null, debugLevel.info);
        return children;
    }
